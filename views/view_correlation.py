...
class ViewCorrelation(AbstractView):
    ...
    def generate_fig(self, opnrcd_df, normalized_time_series, **kwargs):
        ...
        corr_df = self.df[NUMERICAL_VARIABLES + ['Dauer (m)', 'Baujahr']].dropna().corr()
        self.fig = px.imshow(corr_df, color_continuous_scale=px.colors.diverging.RdBu, color_continuous_midpoint=0)
