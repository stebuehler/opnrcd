...
class ViewBox(AbstractView):
    def __init__(self):
        ...
        self.add_display_option('Geigengrafik', ['An', 'Aus'], toggle=True, default_selection=1)
    ...
    def generate_fig(self, opnrcd_df, normalized_time_series, time_series_by_year, **kwargs):
        ...
        violin_bool = kwargs[self.get_display_option_id('Geigengrafik')]
        violin = True if violin_bool == 'An' else False
